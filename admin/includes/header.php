...
// PROTEKSI KETAT: Cek autentikasi dan otorisasi role khusus admin
if (!isset($_SESSION['role']) || $_SESSION['role'] !== 'admin') {
    header('Location: ../index.php');
    exit();
}

// Nama admin dinamis dari session login
            ...
            <div class="p-6 flex-1 overflow-y-auto min-h-0">
                ...
                <nav class="space-y-1.5">
                    ...
                    $menus = [
                        ...
                        ['tambah-penyelenggara.php', 'fas fa-user-plus', 'Tambah Penyelenggara'],
                ...
                <button type="button" onclick="toggleProfileDropdown(event)" class="w-full flex items-center justify-between p-2 rounded-2xl hover:bg-white/10 transition-all text-left group">
                    <div class="flex items-center gap-3 overflow-hidden">
                        ...
                        <div class="overflow-hidden">
                            <p class="text-sm font-bold text-white truncate"><?= htmlspecialchars($admin_name) ?></p>
